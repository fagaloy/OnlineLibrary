<?php
  ...
  include('mylibrary-functions/functions.php');
?>
<!DOCTYPE html>
<html lang="en">
          ...
          <table id="multi_login" class="table table-striped">
            ...
            ?>
              <tr>
                ...
                <td>
                  <button type="button" class="btn btn-info viewBtn"> <i class="fas fa-eye"> View Book</i></button>

                  <button  type="button" class="btn btn-success addBtn"> <i class="fas fa-book"> Borrow Book</i></button>
                </td>
              </tr>
            <?php
              }
          ...
          <form action="book-transaction.php" method="POST">
            ...
            <div class="form-group">
              <input readonly type="hidden" name="updateGenre" id="updateGenre" class="form-control" maxlength="50" required>
                        ...
                        <div class="form-group">
              <input type="hidden" name="status" id="status" class="form-control" value ="Pending" maxlength="50" required>
            </div>
                        <div class="form-group">
              <label for="title">Enter your username</label>
              <input type="text" name="borrower" id="borrower" class="form-control" placeholder="Enter Username" maxlength="50"
                required>
            </div>
            <div class="modal-footer">
              <button type="submit" class="btn btn-primary" name="sendData">Issue Book</button>
            </div>
          </form>
        </div>
      </div>
